...
Implement a custom focus-visible style: a border or outline in a color that achieves 3:1
contrast against the input background, sitting outside the shadow stacking context.
...
_container_ can have a subtle raised card treatment. The table interior remains completely flat.
